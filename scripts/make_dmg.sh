...
cd "$(dirname "$0")/.."
APP_PATH="dist/HushScribe.app"
DMG_PATH="dist/HushScribe.dmg"
...
TEMP_DMG="dist/HushScribe_temp.dmg"
...
hdiutil create -volname "HushScribe" -srcfolder "$STAGING_DIR" -ov -format UDRW "$TEMP_DMG"
...
tell application "Finder"
  tell disk "HushScribe"
    ...
    set position of item "HushScribe.app" of container window to {120, 150}
